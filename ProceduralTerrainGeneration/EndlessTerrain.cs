...
public class EndlessTerrain : MonoBehaviour
{
    ...
    void Update() {
        viewerPosition = new Vector2(viewr.position.x, viewr.position.z) / scale;
        ...
        for (int yOffset = -chunksVisibleInViewDistance; yOffset <= chunksVisibleInViewDistance; yOffset++) {
            for (int xOffset = -chunksVisibleInViewDistance; xOffset <= chunksVisibleInViewDistance; xOffset++) {
                ...
                if (terrainChunkDictionary.ContainsKey(viewedChuckCoord)) {
                    ...
                    terrainChunkDictionary.Add(viewedChuckCoord, new TerrainChunk(viewedChuckCoord, chunckSize, detailLevels, transform, mapMaterial));
                }
            }
        }
    }
